import {
  ...
  zoom_default
} from "./chunk-GJAQGSQT.js";
import "./chunk-3XS2ADE6.js";
import "./chunk-3QKMDCEG.js";
import {
  require_react_dom
...
function NodeToolbar({ nodeId, children, className, style: style2, isVisible, position = Position.Top, offset = 10, align = "center", ...rest }) {
  ...
  return import_react5.default.createElement(
    NodeToolbarPortal,
    null,
    import_react5.default.createElement("div", { style: wrapperStyle2, className: cc(["react-flow__node-toolbar", className]), ...rest }, children)
  );
}
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style2 = {}, children, color, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  const startValues = (0, import_react6.useRef)(initStartValues);
  const prevValues = (0, import_react6.useRef)(initPrevValues);
  const getPointerPosition = useGetPointerPosition();
  ...
  return import_react6.default.createElement("div", { className: cc(["react-flow__resize-control", "nodrag", ...positionClassNames, variant, className]), ref: resizeControlRef, style: controlStyle }, children);
}
var ResizeControl$1 = (0, import_react6.memo)(ResizeControl);
...
function NodeResizer({ nodeId, isVisible = true, handleClassName, handleStyle, lineClassName, lineStyle, color, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  return import_react6.default.createElement(
    ...
    null,
    lineControls.map((c) => import_react6.default.createElement(ResizeControl$1, { key: c, className: lineClassName, style: lineStyle, nodeId, position: c, variant: ResizeControlVariant.Line, color, minWidth, minHeight, maxWidth, maxHeight, onResizeStart, keepAspectRatio, shouldResize, onResize, onResizeEnd })),
    handleControls.map((c) => import_react6.default.createElement(ResizeControl$1, { key: c, className: handleClassName, style: handleStyle, nodeId, position: c, color, minWidth, minHeight, maxWidth, maxHeight, onResizeStart, keepAspectRatio, shouldResize, onResize, onResizeEnd }))
  );
}
export {
