...
var Panel = (0, import_react.forwardRef)(({ position = "top-left", children, className, style: style2, ...rest }, ref) => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className: cc(["react-flow__panel", className, ...positionClasses]), style: { ...style2, pointerEvents }, ref, ...rest, children });
});
...
var createStore = ({ nodes, edges, defaultNodes, defaultEdges, width, height, fitView, nodeOrigin, nodeExtent }) => createWithEqualityFn((set, get) => {
  async function resolveFitView() {
    const { nodeLookup, panZoom, fitViewOptions, fitViewResolver, width: width2, height: height2, minZoom, maxZoom } = get();
    if (!panZoom) {
      return;
    }
    await fitViewport({
  ...
  return {
    ...
    setNodes: (nodes2) => {
      ...
      if (fitViewQueued && nodesInitialized) {
        resolveFitView();
        set({ nodes: nodes2, fitViewQueued: false, fitViewOptions: void 0 });
      } else {
        set({ nodes: nodes2 });
      }
    },
...
function Wrapper({ children, nodes, edges, defaultNodes, defaultEdges, width, height, fitView, nodeOrigin, nodeExtent }) {
  ...
  return (0, import_jsx_runtime.jsx)(ReactFlowProvider, { initialNodes: nodes, initialEdges: edges, defaultNodes, defaultEdges, initialWidth: width, initialHeight: height, fitView, nodeOrigin, nodeExtent, children });
}
var wrapperStyle = {
  width: "100%",
  height: "100%",
